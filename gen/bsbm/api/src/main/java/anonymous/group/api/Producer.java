...
public class Producer {
    ...
    public Producer setLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public Producer setComment(String comment) {
    ...
    public Producer setHomepage(String homepage) {
    ...
    public Producer setPublisher(String publisher) {
    ...
    public Producer setDate(Long date) {
        this.date = date;
        return this;
    }
    ...
    public Producer setType(List<Long> type) {
        this.type = type;
        return this;
    }
