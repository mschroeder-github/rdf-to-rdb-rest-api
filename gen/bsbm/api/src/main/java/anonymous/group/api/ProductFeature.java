...
public class ProductFeature {
    ...
    public ProductFeature setLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public ProductFeature setComment(String comment) {
    ...
    public ProductFeature setPublisher(String publisher) {
    ...
    public ProductFeature setDate(Long date) {
        this.date = date;
        return this;
    }
    ...
    public ProductFeature setType(List<Long> type) {
        this.type = type;
        return this;
    }
