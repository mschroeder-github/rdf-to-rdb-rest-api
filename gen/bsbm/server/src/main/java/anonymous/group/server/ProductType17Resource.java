...
import anonymous.group.api.ProductType17;
...
public class ProductType17Resource {

    private DatabaseController dbc;

    public ProductType17Resource(DatabaseController dbc) {
        this.dbc = dbc;

        Spark.get("/productType17", this::getProductType17);
        Spark.get("/productType17/:id", this::getProductType17Id);

        Spark.delete("/productType17", this::deleteProductType17);
        Spark.delete("/productType17/:id", this::deleteProductType17Id);

        Spark.post("/productType17", this::postProductType17);

        Spark.put("/productType17/:id", (req, resp) -> putOrPatchProductType17Id(req, resp, true));
        Spark.patch("/productType17/:id", (req, resp) -> putOrPatchProductType17Id(req, resp, false));

        Spark.options("/productType17", this::optionsProductType17);
    }

    public Object getProductType17(Request req, Response resp) {
        return getProductType17(req, resp, null);
    } 

    public Object getProductType17Id(Request req, Response resp) {
        return getProductType17(req, resp, getIds(req));
    }

    private Object getProductType17(Request req, Response resp, List<Long> ids) {
        ...
        result.put("type", "ProductType17");
        
        List<ProductType17> records = dbc.selectProductType17(ids, offset, limit, rqlNode);
    ...
    public Object postProductType17(Request req, Response resp) {
        JSONObject json = toJSONObject(req);
        ProductType17 record = fromJSONObject(json);
        dbc.insertProductType17(Arrays.asList(record));
        resp.header("Location", "/productType17/" + record.getId());
        resp.status(201);
        return "";
    }

    public Object putOrPatchProductType17Id(Request req, Response resp, boolean put) {
        List<Long> ids = getIds(req);
        JSONObject json = toJSONObject(req);
        ProductType17 record = fromJSONObject(json);
        record.setId(ids.get(0));
        List<ProductType17> records = dbc.selectProductType17(ids, null, null, null);
        if(records.isEmpty()) {
            resp.status(404);
            return "no ProductType17 with id " + ids.get(0);
        }
        dbc.updateProductType17(Arrays.asList(record), put);
        resp.status(204);
        return "";
    }

    public Object deleteProductType17(Request req, Response resp) {
        dbc.deleteProductType17();
        resp.status(204);
        return "";
    }

    public Object deleteProductType17Id(Request req, Response resp) {
        dbc.deleteProductType17(getIds(req));
        resp.status(204);
        return "";
    }

    public Object optionsProductType17(Request req, Response resp) {
    ...
    public JSONArray toJSONArray(List<ProductType17> records) {
    ...
    public JSONObject toJSONObject(ProductType17 record) {
        JSONObject result = new JSONObject();
        JSONUtils.forceLinkedHashMap(result);
    ...
    public ProductType17 fromJSONObject(JSONObject jsonObject) {
